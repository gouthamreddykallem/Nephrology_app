...
class QuickLinks extends StatefulWidget {
  ...
  const QuickLinks({Key? key, required this.paymentKey, required this.portalKey}) : super(key: key);
                          ...
                          children: [
                            ...
                            if (section.title == "Make a Payment")
                              Showcase(
                                ...
                                description: 'Tap here to make a payment',
                                child: ElevatedButton(
                                  onPressed: () => _launchPhone(section.link),
                            ...
                            else if (section.title == "Visit Patient Portal")
                              Showcase(
                                key: widget.portalKey,
                                description: 'Tap here to visit the patient portal',
                                child: ElevatedButton(
                                  onPressed: () => Utilities.urlLauncher(Uri.parse(section.link)),
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: Colors.white,
                                    foregroundColor: primaryColor,
                                  ),
